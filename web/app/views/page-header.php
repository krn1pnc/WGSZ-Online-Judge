...
<html lang="<?= UOJLocale::locale() ?>">
	<head>
		...
		<!-- favicon -->
		<link rel="shortcut icon" href="<?= HTML::url("/images/" . UOJConfig::$data['profile']['oj-favicon-name'] . ".ico") ?>" />
	...
	<body role="document">
		<div class="container theme-showcase" role="main">
			...
			<div>
				...
				<?php if (Auth::check()): ?>
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li role="presentation"><a class="dropdown-item" href="<?= HTML::url('/upload-list/' . Auth::id()) ?>">文件上传</a></li>
				...
				<h1 class="d-none d-sm-block"><a href="<?= HTML::url('/') ?>"><img src="<?= HTML::url("/images/" . UOJConfig::$data['profile']['oj-logo-name'] . "_small.png") ?>" alt="Logo" class="img-rounded" style="width:39px; height:39px;" /></a> <?= $PageMainTitle ?></h1>
