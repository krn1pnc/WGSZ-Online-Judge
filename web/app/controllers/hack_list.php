...
<div class="d-none d-sm-block">
	...
	<form id="form-search" class="form-inline" role="form">
		<div id="form-group-submission_id" class="form-group">
			<label for="input-submission_id" class="control-label" style="margin-right: 0.5em;"><?= UOJLocale::get('problems::submission id') ?>:</label>
			<input type="text" class="form-control input-sm" name="submission_id" id="input-submission_id" value="<?= $q_submission_id ?>" maxlength="6" style="width: 5em; margin-right: 0.5em;" />
		</div>
		...
		<div id="form-group-hacker" class="form-group">
			<label for="input-hacker" class="control-label" style="margin-right: 0.5em;"><?= UOJLocale::get('problems::hacker') ?>:</label>
			<input type="text" class="form-control input-sm" name="hacker" id="input-hacker" value="<?= $q_hacker ?>" maxlength="100" style="width: 10em; margin-right: 0.5em;" />
		</div>
		<div id="form-group-owner" class="form-group">
			<label for="input-owner" class="control-label" style="margin-right: 0.5em;"><?= UOJLocale::get('problems::owner') ?>:</label>
			<input type="text" class="form-control input-sm" name="owner" id="input-owner" value="<?= $q_owner ?>" maxlength="100" style="width: 10em; margin-right: 0.5em;" />
		</div>
		<div id="form-group-status" class="form-group">
			<label for="input-status" class="control-label" style="margin-right: 0.5em;"><?= UOJLocale::get('problems::result') ?>:</label>
